...
CREATE INDEX idx_daily_closures_date ON public.daily_closures(date);
...
-- =====================================================
-- TABLA: coupons (opcional para descuentos)
-- =====================================================
...
SELECT
    ...
    'guantes-touring-premium',
    'Guantes de cuero genuino con protecciones en nudillos. Impermeables y con pantalla táctil compatible.',
    12000000,
    8000000,
    id,
    25,
...
SELECT
    ...
    'candado-alarma-premium',
    'Candado de disco con alarma de 110dB. Resistente al agua y con batería recargable.',
    8500000,
    5000000,
    id,
    30,
